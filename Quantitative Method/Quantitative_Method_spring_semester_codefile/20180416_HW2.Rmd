...
e.g. McKinsey
1. the different roles of employees
The data do not adjust for employees’ different roles, so chief executives are compared directly with secretaries.
2. Industry
Airlines have reported some of the widest pay gaps, yet are unlikely to have unequal pay, because collective bargaining tends to determine salaries in the industry. Of easyJet’s pilots, 94% are men (average salary: £92,400) whereas 69% of cabin crew are women (earning an average of £24,800). The airline industry does not have a pay-discrimination problem so much as a recruitment problem.
3. childbearing
Men’s and women’s salaries start diverging from the childbearing years. This “motherhood penalty” is often followed by the “good-daughter penalty”, when elderly parents require care and daughters prove more conscientious than sons. The median pay gap is only 2% among full-time workers in their 30s, yet jumps to 14% in their 40s and 16% in their 50s, according to the Office for National Statistics.
```